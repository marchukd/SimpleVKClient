...
/**
 * Created by Dmytro on 12.11.2015.
 */
public class FriendsOnlineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.friends_online_fragment, null);

        ListView listView = (ListView) view.findViewById(R.id.friends_online_list);
