...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VKSdk.customInitialize(this, getResources().getInteger(R.integer.app_id), "5.40");
        if (!VKSdk.isLoggedIn())
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_friends) {
            ...
            transaction.commit();
        } else if (id == R.id.nav_friends_online) {
            FriendsOnlineFragment ff = new FriendsOnlineFragment();
            transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container, ff);
            transaction.commit();
        }
